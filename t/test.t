...
sub hashtest {
	...
	my $encoded = argon2i_pass($password, $salt, $t_cost, 1 << $m_cost, $parallelism, 32);
	...
	my $hex = argon2i_hex($password, $salt, $t_cost, 1 << $m_cost, $parallelism, 32);
...
hashtest(2, 20, 1, 'password', 'somesalt',
